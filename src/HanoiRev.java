...
public class HanoiRev {
    ...
    public static void main(String[] args) {
        ...
        HanoiRev hanoiRev = new HanoiRev(6);
        hanoiRev.solve();
        System.out.println(hanoiRev.towerA);
        System.out.println(hanoiRev.towerB);
        System.out.println(hanoiRev.towerC);
